...
<header>
    ...
    <p>[Your LinkedIn Profile URL (Optional)]</p>
</header>
...
<ul>
    <li>**Impact:** Empowered stakeholders to optimize policy distribution strategies and target high-opportunity regions.</li>
    <li>**Technologies Used:** Python, R, Power BI, XGBoost, Random Forest, Stacking Regressor.</li>
</ul>
...
<ul>
    <li>**Processing:** Initial data cleaning and preparation performed in R for optimal data manipulation</li>
    <li>**Standardized:** Reformatted ZIP codes for consistency</li>
    <li>**Joined:** Merged RLI insurance data with U.S. Census demographics by ZIP code</li>
    <li>**Output:** A consolidated dataset for modeling and analysis</li>
</ul>

<h2>2. Machine Learning</h2>
<ul>
    <li>**Target Variable:** Policy count per ZIP code (aggregated from individual policy data)</li>
    <li>**Data Scale:** 866,000 rows × 52 columns (2GB dataset)</li>
    <li>**Processing Optimization:** Implemented chunking to handle large data volume efficiently</li>
    <li>**Models Used:**
        <ul>
    ...
    <li>**Training Time:** Several hours of computation due to dataset size</li>
    <li>**Key Metrics:**
        <table>
            <tr>
                <th>Model</th>
...
<img src="https://github.com/TommyHeideman/RLI_project/raw/main/PowerBI_map.png" alt="Power BI map showing model predictions and comparison to RLI policy counts">
<img src="https://github.com/TommyHeideman/RLI_project/raw/main/Model_Demographics.png" alt="Demographics model insights visualization">
...
<ul>
    ...
    <li>**NDA Restrictions:** Due to confidentiality agreements, only summary results are shared, with no access to proprietary or provider-specific data.</li>
</ul>

<h2>6. Key Deliverables</h2>
<ul>
    <li>**Cleaned Datasets:** Prepared for further analysis or integration.</li>
    <li>**Predictive Models:** Saved in joblib format for reproducibility.</li>
    <li>**Interactive Dashboard:** Delivered actionable insights to stakeholders.</li>
</ul>
